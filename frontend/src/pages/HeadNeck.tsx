      ...
      <UniformGrid columns={[1, 1, 2]} gap={4} columnGap={7}>
        <VStack align="flex-start">
          ...
          <Text marginTop="1rem">
            ...
            that affects your self-image and quality of life. It is important to be kind to yourself during this
            stressful time.
          </Text>
          ...
          <UnorderedList pl={4}>
            <ListItem>
              Talking about your feelings with a counselor, a family member, or a friend may provide comfort. It may
              also be helpful to connect with other people who have experienced hair loss, such as through an online
              support group, and find out what worked best for them in coping with it.
            </ListItem>
            <ListItem>
              It may be helpful to prepare your family and friends about you possibly losing hair. This is especially
              true for children. They may feel less fearful and anxious if the change in your appearance is something
              they expect. This, in turn, can help you feel better.
            </ListItem>
            <ListItem>
            ...
            <ListItem>
              Some people decide to shave their head in advance or once hair loss begins. This can help wigs or other
              head coverings fit better. Hairdressers can help with this.
            </ListItem>
            <ListItem>
              If you want to wear a scarf, hat, or other head coverings, get some of those items in advance. This can
              make you feel more prepared for when hair loss starts happening. Select those made from soft materials
              that don't itch. It may be helpful to have items in both lighter and heavier materials, for your comfort
        ...
        <VStack align="flex-start">
          ...
          <UnorderedList pl={4}>
            ...
            <ListItem>
              Dehydration (not getting the amount of water the body needs to be healthy) caused by being unable to
              drink.
            </ListItem>
          ...
          <UnorderedList pl={4}>
            ...
            <UnorderedList pl={4}>
              <ListItem>
                Brush teeth and gums with a soft-bristle brush 2 to 3 times a day for 2 to 3 minutes. Be sure to brush
                the area where the teeth meet the gums and to rinse often.
              </ListItem>
              <ListItem>
              ...
              <ListItem>
                Use a fluoride toothpaste with a mild taste. Flavoring may irritate the mouth, especially mint
                flavoring.
              </ListItem>
              <ListItem>
                If toothpaste irritates your mouth, brush with a mixture of 1/4 teaspoon of salt added to 1 cup of
                water.
              </ListItem>
            </UnorderedList>
            <ListItem>
            ...
            <UnorderedList lp={4}>
              ...
              <ListItem>
                If dry mouth occurs, rinsing may not be enough to clean the teeth after a meal. Brushing and flossing
                may be needed.
              </ListItem>
            </UnorderedList>
            <ListItem>
            ...
            <UnorderedList lp={4}>
              ...
              <ListItem>
                Keep dentures moist when not being worn. Place them in water or a denture soaking solution recommended
                by your dentist. Do not use hot water, which can cause the denture to lose its shape.
              </ListItem>
            </UnorderedList>
          </UnorderedList>
        </VStack>
