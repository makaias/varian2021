...
import {useSlate, ReactEditor, RenderLeafProps, RenderElementProps} from 'slate-react';
...
export const Toolbar = () => {
  return (
    <HStack borderWidth={'0 0 1px 0'} borderColor="primary.200" padding={'10px 5px'} spacing={'5px'} wrap={'wrap'}>
...
export const Leaf = ({attributes, children, leaf}: RenderLeafProps) => {
  ...
  if (leaf.code) {
    children = (
      <chakra.code padding={'3px'} backgroundColor={colorMode === 'dark' ? 'gray.700' : 'gray.200'} fontSize={'90%'}>
        {children}
      </chakra.code>
    );
  }
